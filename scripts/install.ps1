#
# sapient CLI Installation Script for Windows
...
function Install-CLI {
    Write-ColorOutput "Installing sapient CLI..." -Color Green
    ...
    $archiveName = "sapient_Windows_$arch.zip"
    $downloadUrl = "https://github.com/$Repo/releases/download/$Version/$archiveName"

    Write-ColorOutput "Downloading from: $downloadUrl" -Color Cyan

    # Create temporary directory
    $tempDir = Join-Path $env:TEMP "sapient-install-$(New-Guid)"
    ...
    try {
        ...
        Write-ColorOutput "sapient $Version has been installed to $binaryPath" -Color Green
        ...
        Write-ColorOutput "Installation successful! Run 'sapient --help' to get started." -Color Green
