...
// @generated-id: f4b8245f5509

package sdk

// Generated from OpenAPI doc version 1.0.0 and generator version 2.889.1

import (
	"context"
	"fmt"
	"github.com/usesapient/cli/internal/sdk/models/components"
	"github.com/usesapient/cli/internal/sdk/retry"
...
var ServerList = []string{
	// Production
	"https://api-public.usesapient.com",
}
...
type SDKOption func(*Sapient)

// WithServerURL allows providing an alternative server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *Sapient) {
...
func New(opts ...SDKOption) *Sapient {
	sdk := &Sapient{
		SDKVersion: "0.0.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.0.1 2.889.1 1.0.0 github.com/usesapient/cli/internal/sdk",
