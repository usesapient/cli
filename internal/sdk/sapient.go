...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.887.0
...
func New(opts ...SDKOption) *Sapient {
	sdk := &Sapient{
		SDKVersion: "0.0.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.0.1 2.887.0 1.0.0 github.com/usesapient/cli/internal/sdk",
