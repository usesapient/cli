...
func NewRootCommand() (*cobra.Command, error) {
	...
	rootCmd := &cobra.Command{
		Use:           "sapient",
		Short:         "Sapient Public API: Public API for Sapient CLI and external integrations",
		Long:          "Sapient Public API: Public API for Sapient CLI and external integrations.",
		SilenceUsage:  true,
		SilenceErrors: true,
	...
	if err := status.InitStatusRoot(rootCmd); err != nil {
	...
	rootCmd.PersistentFlags().String("sapient-api-key-auth", "", "API Key")
	_ = rootCmd.PersistentFlags().SetAnnotation("sapient-api-key-auth", "speakeasy:group", []string{"Authentication"})
