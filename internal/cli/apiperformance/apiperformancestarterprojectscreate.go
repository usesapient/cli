...
func initApiPerformanceStarterProjectsCreateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "starter-projects-create",
		Short:   "Create Starter Project",
		Long:    "Create Starter Project",
		Example: "  sapient api-performance starter-projects-create --name <value> --repo-url https://aggressive-procurement.org/",
		RunE:    runApiPerformanceStarterProjectsCreateCmd,
		Aliases: []string{"spc"},
	}
...
// runApiPerformanceStarterProjectsCreateCmd executes the api-performance-starter-projects-create command.
func runApiPerformanceStarterProjectsCreateCmd(cmd *cobra.Command, args []string) error {
	if usage.UsageRequested(cmd) {
		return usage.EmitSchema(cmd, cmd.OutOrStdout())
	}
	if interactive.ShouldPrompt(cmd, apiPerformanceStarterProjectsCreateCmdMeta) {
		if err := interactive.PromptAndSetFlags(cmd, apiPerformanceStarterProjectsCreateCmdMeta); err != nil {
			return err
		}
	}
