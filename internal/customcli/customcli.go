...
var commandMoves = []commandMove{
	...
	{From: []string{"api-performance", "config-update"}, To: []string{"api-performance", "config", "update"}},
	{From: []string{"api-performance", "sources-list"}, To: []string{"api-performance", "sources", "list"}},
	{From: []string{"api-performance", "skills-list"}, To: []string{"api-performance", "skills", "list"}},
	{From: []string{"api-performance", "evals-list"}, To: []string{"api-performance", "evals", "list"}},
	{From: []string{"api-performance", "evals-retrieve"}, To: []string{"api-performance", "evals", "retrieve"}},
	...
	{From: []string{"api-performance", "starter-projects-list"}, To: []string{"api-performance", "starter-projects", "list"}},
	{From: []string{"api-performance", "starter-projects-create"}, To: []string{"api-performance", "starter-projects", "create"}},
	{From: []string{"api-performance", "starter-projects-retrieve"}, To: []string{"api-performance", "starter-projects", "retrieve"}},
	{From: []string{"api-performance", "starter-projects-update"}, To: []string{"api-performance", "starter-projects", "update"}},
	{From: []string{"api-performance", "starter-projects-delete"}, To: []string{"api-performance", "starter-projects", "delete"}},
	{From: []string{"api-performance", "actions-list"}, To: []string{"api-performance", "actions", "list"}},
	{From: []string{"api-performance", "actions-refresh"}, To: []string{"api-performance", "actions", "refresh"}},
	{From: []string{"api-performance", "actions-retrieve"}, To: []string{"api-performance", "actions", "retrieve"}},
	{From: []string{"api-performance", "actions-update"}, To: []string{"api-performance", "actions", "update"}},
	{From: []string{"api-performance", "actions-verify"}, To: []string{"api-performance", "actions", "verify"}},
}
